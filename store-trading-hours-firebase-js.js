    ...
    $("#getStoreLocator").keyup(function(event) {
        ...
        var focused = $("#suggestionList").find("li.active");
        var rec = $("#suggestionList").find("li").length > 0 ? true : false;
    ...
    $("#btn_search").click(function(event) {
        ...
        if (userInput.length > 2) {
            if(rec) {
                var getDefaultRecommendation = $("#suggestionList").first().html();
                console.log(getDefaultRecommendation);
                getStoresList(getDefaultRecommendation);
                clearSuggList();
            } else {
    ...
    function displayStores(stores) {
        ...
        function getExceptionToday(data, name) {
            var res;
